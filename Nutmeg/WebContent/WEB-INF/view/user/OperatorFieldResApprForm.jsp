...
<script type="text/javascript">
	...
	{
		var type = $('#rejectModal select').val();
		var reason = $('#rejectModal textarea').val();
		var fieldResId = $('#rejectModal input[name="field_res_id"]').val(); // form에 숨겨진 input 필요
	...
	<div class="match-card border rounded p-3 mb-3">
		<div class="d-flex justify-content-between align-items-center">
			...
			<div>
				...
				시작 시간 : ${field.stadium_time_at1}<br>
				종료 시간 : ${field.stadium_time_at2}
			</div>
