...
<script type="text/javascript" src="<%=cp %>/js/TeamUpdate.js?after"></script>

</head>
<body>
<div class="content">
	<form method="post" action="TeamInsert.action" class="form form--join" enctype="multipart/form-data">
		<h2 class="form__title">동호회 정보 수정</h2>
		...
		<div class="form__actions">
			<button type="submit" id="submitBtn" class="btn btn--submit">수정하기</button>
