...
public class FieldRegInsertDTO
{
	private int field_reg_id, field_size_id
			  , stadium_reg_id, field_reg_price;
	private String field_reg_name, field_reg_at, field_size_capacity
	 			 , field_environment_type, field_type, field_size_type;
	...
	public String getField_size_type()
	{
		return field_size_type;
	}
	public void setField_size_type(String field_size_type)
	{
		this.field_size_type = field_size_type;
	}
