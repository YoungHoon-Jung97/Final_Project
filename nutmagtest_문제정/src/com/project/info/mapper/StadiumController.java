...
import com.project.info.FieldEnvironmentDTO;
import com.project.info.FieldTypeDTO;
import com.project.info.IFieldDAO;
...
public class StadiumController
{
	...
	public String fieldInsert(Model model,FieldTypeDTO fieldType, FieldEnvironmentDTO environment) throws SQLException
	{
		...
		result = "/WEB-INF/view/FieldRegInsertForm.jsp";
		return result;
	}
