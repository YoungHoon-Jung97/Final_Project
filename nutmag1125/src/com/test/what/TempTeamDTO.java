...
{
	private int temp_team_id, user_code_id, bank_id, region_id, temp_team_person_count;
	private String temp_team_name, temp_team_desc, temp_team_emblem,
				   temp_team_apply_at, temp_team_account, temp_team_account_holder,
				   bank_name, city_id;
