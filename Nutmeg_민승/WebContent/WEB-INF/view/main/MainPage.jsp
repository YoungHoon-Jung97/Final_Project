...
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/css/modal.css?after">
<link rel="stylesheet" type="text/css"
	href="<%=cp%>/css/MainPage.css?after">
...
<body>
	...
	<div id="descModal" class="modal">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" id="cancel-desc"
					class="btn modal-cancel cancel-btn">취소</button>
			</div>
		</div>
	</div>
							...
							<div class="card">
								<div class="card-img">
									...
									<c:choose>
										...
										<c:when test="${team.emblem == '/' || team.emblem == null}">
											<img src="images/noEmblem.png"
												alt="${team.temp_team_name} 앰블럼">
										</c:when>
									</c:choose>
								</div>
								...
								<div class="card-content">
									...
									<input id="teamName" type="hidden"
										value="${team.temp_team_name}"> <input id="teamDesc"
										type="hidden" value="${team.temp_team_desc}"> <input
										id="teamRegion" type="hidden" value="${team.region_name}">
									<input id="teamCity" type="hidden" value="${team.city_name}">
									<input id="teamMemberCount" type="hidden"
										value="${team.member_count}"> <input id="teamEmblem"
										type="hidden" value="${team.emblem}" /> <input id="teamStaus"
										type="hidden" value="${team.team_id}"> <input
										id="teamId" type="hidden" value="${team.temp_team_id}">
	...
	<div id="filterPanel" class="filter-panel">
		...
		<form method="get" action="">
			<div class="mb-3">
				<label for="regionSelect" class="form-label">지역</label> <select
					id="regionSelect" name="region" class="form-select">
	...
	<div class="floatingButton-wrapper">
		...
		<div id="floatingButton" class="floatingButton">
			<img src="images/soccerball.png" alt="floating"
				class="floatingButton-img">
		</div>
	</div>
			...
			if (modal && modal.style.display === "flex")
				{
						...
						// 흐림 효과 제거
						document.querySelector(".floatingButton-wrapper").classList.remove("blur-background");
